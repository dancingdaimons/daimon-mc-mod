...
public class JimmyEntityModel extends BtsEntityModel<JimmyEntity> {
    public JimmyEntityModel(float scale, boolean bl) {
        this(scale, 0.0F, 64, bl ? 32 : 64);
    }

    protected JimmyEntityModel(float f, float g, int i, int j) {
        super(f, g, i, j);
    }
